...
def dydt(t,y):
    ...
    k_ads_7 = k_ads(T, P_N2, 1e-20, m_N2)            # N2 adsorption and adsorption
        ...
        #formation of H2
    k_des_8 = k_des(T, 1e-20, m_H, 2, 87.6, 20e3)   # H2 desorption and adsorption
    ...
    dydt[0] = -r1     # d P(NH3)/dt

    dydt[1] = r1 - r2   # Th_NH3
    dydt[2] = r2 - r3   # Th_NH24
    dydt[3] = r3 - r4   # Th_NH
    dydt[4] = r4 - 2*r5 # Th_N
    dydt[5] = r5 - r6   # Th_N-N
    dydt[6] = r6 - r7   # Th_N2
...
r = solve_ivp(dydt, (0,t_end), y0, method="BDF", t_eval=np.linspace(0,t_end,10000))
...
k_des_7 = k_des(T, 1e-20, m_N2, 2, 2.88, 20e3)  # N2 desorption and adsorption
k_ads_7 = k_ads(T, P_N2, 1e-20, m_N2)            # N2 adsorption and adsorption

k_des_8 = k_des(T, 1e-20, m_H, 2, 87.6, 40e3)   # H2 desorption and adsorption
k_ads_8 = k_ads(T, P_H2, 1e-20, m_H2)            # H2 adsorption and adsorption

        # rate calc
rf1 = k_ads_1 * Th
rb1 = k_des_1 * Th_NH3 ; r_nh3 = rb1 #-rf1

rf7 = k_des_7 * Th_N2
rb7 = k_ads_7 * Th  ; r_n2 = rf7-rb7

rf8 = k_des_8 * Th_H**2 #good
rb8 = k_ads_8 * Th**2  ; r_h2 = rf8-rb8


# 5/ Plot rate Vs Temperature

#plt.plot(T,r_nh3, label= "NH3")
# plt.plot(T,r_n2, label= "N2")
# plt.plot(T,r_h2, label= "H2")
